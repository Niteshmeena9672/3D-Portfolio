...
import gym_icon from '../../assests/gym_icon.ico';
...
import property_icon from '../../assests/property_icon.png';
...
export const navLinks = [
  ...
  {
    id : "https://drive.google.com/file/d/1pNZgL_8M6Qsu6LHrNjIa0CIg-TIwb2Ie/view?usp=sharing",
    title : "Resume"
  }
];
...
const experiences = [
  ...
  {
    title: "Fitness First",
    project_sub_title: "Fitness Exercise Web App",
    icon: gym_icon, // replace with actual icon
    iconBg: "#383E56",
    date: "Nov 2023 - Dec 2023",
    github_link: "https://github.com/Niteshmeena9672/Fitness-Exercises-App", // Replace with actual link if available
    website_link: "https://fitnessfirst.netlify.app", // Replace with actual website link if available
    points: [
      "Developed a fitness exercise web app aimed at empowering users to achieve their fitness goals by providing access to over 500+ instructional videos integrated with YouTube.",
      "Implemented a search functionality that allows users to find exercises by name or body part for a personalized workout experience.",
      "Used pagination for smooth navigation through the exercise list, ensuring a seamless user experience even with large data sets.",
      "Built with a user-friendly and intuitive design using Material-UI to enhance user interaction and experience.",
    ],
    tags: [
      {
        name: "React.Js",
  ...
  },
  {
    ...
    project_sub_title: "Real Estate Web App",
    icon: property_icon, // replace with actual icon
    iconBg: "#383E56",
    date: "Jan 2024 - Feb 2024",
    github_link: "https://github.com/Niteshmeena9672/Property-Locator-mern", // Replace with actual link if available
    website_link: "https://propertylocator.netlify.app", // Replace with actual website link if available
    points: [
      "Developed a Real Estate Web App for house hunting, implementing CRUD functionality for property listings and an efficient search feature by property name.",
    "Designed and integrated customizable filtering options and an image carousel for showcasing property images.",
    "Implemented authentication with JWT and Google OAuth, enhancing security and user login experience.",
  ],
    tags: [
      {
        name: "React.js",
...
// },
...

  {
    ...
    project_sub_title: "Fault Diagnosis Using Machine Learning",
    icon: active_learning_logo, // replace with actual icon
    iconBg: "#383E56",
    date: "Mar 2024 - Apr 2024",
    github_link: "https://github.com/Niteshmeena9672/Active-Learning/blob/main/Active_Learning.ipynb", // Replace with actual link if available
    points: [
      "Implemented CNN and LSTM models for bearing fault diagnosis, achieving 98.4% accuracy with CNN and 96.8% with LSTM, outperforming SVM (60.8%) and KNN (50%).",
      "Enhanced system reliability by validating models through confusion matrices, precision, recall, and F1 score.",
    ],
    tags: [
      {
        name: "Python",
...
const projects = [
  ...
  // },
  {
    ...
    description:
      "Completed an advanced online web development course with a focus on the MERN stack (MongoDB, Express.js, React, Node.js) and TypeScript.) Created and deployed multiple full-stack web applications, gaining practical experience in web development and software engineering." ,
